...
//printf("here");
  ...
  case 'c': {
    ...
    medicine *cart = (medicine *)malloc(cart_count * sizeof(medicine));
    ...
    char c2;
      ...
      while (logout == 0) {
        ...
        case 1: {
          ...
          cart = realloc(cart, sizeof(medicine) * cart_count);
        ...
        case 2: {
          ...
          medicine *new_cart = (medicine *)malloc((new_cart_count) * sizeof(medicine));
    ...
    printf("                       THANK YOU for using our program!!!....STAY EXCITED AND KEEP GOING!");
